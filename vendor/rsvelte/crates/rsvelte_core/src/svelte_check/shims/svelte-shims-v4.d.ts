...
declare function __sveltets_2_store_get<Store extends SvelteStore<any> | undefined | null>(
  store: Store,
...
declare function __sveltets_2_bubbleEventDef(events: any, eventKey: string): any;
...
declare function __sveltets_2_ensureAction<T extends __sveltets_2_SvelteActionReturnType>(
  actionCall: T,
