...
describe("plugin spec normalization", () => {
  it("keeps package specs and relative file specs unchanged", () => {
    expect(normalizePreservedPluginSpec("prettier-plugin-custom", "/repo")).toBe("prettier-plugin-custom");
  ...
  it("does not rewrite node_modules plugin paths", () => {
    const projectDir = "/repo";
    const pluginPath = join(projectDir, "node_modules", "prettier-plugin-custom", "dist", "index.js");
