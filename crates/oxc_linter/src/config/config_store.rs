...
use super::{
    GlobSet, LintConfig, LintPlugins, OxlintEnv, OxlintGlobals, OxlintSettings,
...
mod test {
    ...
    use crate::{
        ...
        rule::Rule,
        rules::{
            EslintAccessorPairs, EslintCurly, EslintNoUnusedVars, RULES, ReactJsxFilenameExtension,
